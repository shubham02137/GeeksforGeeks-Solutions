<h2><a href="https://www.geeksforgeeks.org/problems/buying-vegetables0016/1?_gl=1*wywvbx*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjwhsrUBhDxARIsAN3AQScsDBd9W5Iuc3kdIwUUTqEOjREzr_RS-0Ioe_1TlALYEI-jP0tcigEaAvfoEALw_wcB&gbraid=0AAAAAC9yBkCHrk4TMT0AtGcDQ1no3gxoZ">Minimum Cost Selection</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an <strong>n × 3</strong> matrix <strong>mat[][]</strong>, where each row represents the costs of three available choices at a shop, </span><span style="font-size: 18px;">select exactly one choice from each row such that the same choice is not selected in two adjacent rows. </span></p>
