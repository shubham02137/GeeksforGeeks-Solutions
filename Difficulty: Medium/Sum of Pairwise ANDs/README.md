<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-products5049/1?_gl=1*h7y9rg*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwnvTUBhBoEiwAZNDxZ_U6a3cDrVfOA35H1Ol2T4-vO502jnkKlBYMeWCEgVp43GYSGTpVixoCQd4QAvD_BwE&gbraid=0AAAAAC9yBkD3ZuNiDiq-v11ZdCLflY7fR">Sum of Pairwise ANDs</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of integers, calculate the sum of bitwise AND for all pairs of elements such that the first index is less than the second index.</span></p>
